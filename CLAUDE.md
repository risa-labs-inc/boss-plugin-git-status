...
**Git Status (Dynamic)** (`ai.rever.boss.plugin.dynamic.gitstatus`) is a dynamic plugin for the BOSS desktop application.

View working tree status and staged changes

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.gitstatus`
- **Main Class**: `ai.rever.boss.plugin.dynamic.gitstatus.GitStatusDynamicPlugin`
- **API Version**: 1.0.20
